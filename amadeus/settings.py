...
SECRET_KEY = 's8w3b5ikz=ver1&zz8v*%gm9a^ywz&+j)2ygmo*uyj^5idrpw%'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'cursos.context_processor.categorias',
                'cursos.context_processor.alunos',
                'cursos.context_processor.cursos',
            ],
        },
    },
]
